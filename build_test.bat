...
@set SOURCES=main.cpp imgui-1.91.5\backends\imgui_impl_opengl3.cpp imgui-1.91.5\backends\imgui_impl_win32.cpp imgui-1.91.5\imgui*.cpp game-library\combat-data.cpp
